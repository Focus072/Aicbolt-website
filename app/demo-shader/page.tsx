          ...
          {user ? (
            <>
              ...
              <Button 
                ...
                size="sm"
                asChild
                className="bg-gray-900/20 border-gray-700/50 backdrop-blur-xl hover:bg-orange-600/20 hover:border-orange-400/50 text-white hover:text-white transition-all duration-300 w-full sm:w-auto"
              >
                <Link href="/dashboard">
        ...
        <main>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
              <div className="text-center">
                ...
                >
                  ...
                  <a 
                    href="#examples" 
                    className="text-sm font-semibold inline-flex items-center gap-2 mt-2 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-orange-500/20 rounded-lg px-3 py-1.5"
                    style={{ 
          ...
          >
            <div className="max-w-[110rem] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 2xl:px-20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 sm:gap-10 md:gap-12 lg:gap-14 xl:gap-12 2xl:gap-16 relative max-w-[140rem] mx-auto">
                {/* Customer Support Agent */}
                <div className="flex justify-center">
                  <div className="w-full max-w-[380px] sm:max-w-[420px] md:max-w-[450px] lg:max-w-[480px] xl:max-w-[520px] h-[720px] sm:h-[740px] md:h-[760px] lg:h-[780px] xl:h-[800px]">
                    <AgentDemoCard
